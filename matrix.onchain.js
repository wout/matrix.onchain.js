...
export const Mtx = {
  /**
    ...
    */
  add(a, b) { return this.op(a, b, (x, y) => x + y) },
  /**
    ...
    * @return {MatrixArray} A new matrix.
    */
  sub(a, b) { return this.op(a, b, (x, y) => x - y) },
  /**
    ...
    * @return {MatrixArray} A new matrix.
    */
  mpy(a, b) { return this.op(a, b, (x, y) => x * y) },
  /**
    ...
    * @return {MatrixArray} A new matrix.
    */
  div(a, b) { return this.op(a, b, (x, y) => x / y) },
  /**
    ...
    */
  op(a, b, c) {
    if (typeof b == 'number') b = this.fill(a.length, a[0].length, b)
